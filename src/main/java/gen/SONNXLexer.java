package gen;// Generated from F:/coding/Grammar/src/main/antlr/SONNXLexer.g4 by ANTLR 4.13.2
...
public class SONNXLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MODELPROTO", "GRAPH", "NAME", "NODE", "INPUT", "OUTPUT", "OP_TYPE", 
	...
	public SONNXLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "SONNXLexer.g4"; }
